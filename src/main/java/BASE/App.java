...
//Challenge
//Modify this program so that instead of prompting for quotes from the user, you create a structure that holds quotes and their associated attributions and then display
...
public class App
{
    ...
    public static void main(String[] args)
    {
        ...
        String quo = in.nextLine();
        System.out.print("Who said it? ");
        String name = in.nextLine();

        //output
        prog.quoteOutput(quo, name);

    }

    private void quoteOutput(String quote, String author)
    {
